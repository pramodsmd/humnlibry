...
Route::group(['prefix'=>'services'],function(){
    ...
    Route::get('/view-service-details_notification_update/{id}','ServiceController@viewServiceDetailsfromNotifcation')->name('admin.service.view.details.notificationupdate');
...
Route::group(['prefix'=>'orders'],function(){
    ...
    Route::get('/order-details-details-from-notification/{id}','OrdersController@orderDetailsNotification')->name('admin.orders.details.notification');
