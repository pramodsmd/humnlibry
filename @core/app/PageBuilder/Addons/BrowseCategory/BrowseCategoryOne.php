...
<div class="single-category-item wow fadeInUp" data-wow-delay=".2s"  type="button" class="btn btn-primary" data-toggle="modal" data-target="#categoryModal">
    <div class="single-category">
        <div class="icon">
           <i class="{$icon}"></i>
        </div>
        <div class="category-contents" >
           <h4 class="category-title"> <a href="javascript::void(0)" data-toggle="tooltip" data-placement="top" title="{$name}"> {$name} </a> </h4>
...
<div class="single-category-item wow fadeInUp" data-wow-delay=".2s"  >
    <div class="single-category">
        ...
        <div class="category-contents">
           <h4 class="category-title"> <a href="{$route}/{$slug}" data-toggle="tooltip" data-placement="top" title="{$name}"> {$name} </a> </h4>
           <span class="category-para"> {$service_count}+ {$static_text['service']} </span>
        </div>
    </div>
</div>
      ...
      <div class="modal-body">
       ...
       <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">No Thanks</button>
          <a type="button" class="btn btn-primary" href="{$routes}" data-toggle="tooltip" >I Agree </a>
      </div>
    </div>
  </div>
</div>
