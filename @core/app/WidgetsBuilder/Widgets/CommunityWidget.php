...
class CommunityWidget extends WidgetBase
{
    ...
    public function frontend_render()
    {
        ...
        <li class="lists">
            <li class="list"><a href="http://humnlibry.sloughmobileapps.co.uk/about">About Us</a></li>
        </li>
        <li class="lists">
            <li class="list"><a href="http://humnlibry.sloughmobileapps.co.uk/faq">FAQ</a></li>
        </li>
        <li class="lists">
            <li class="list"><a href="http://humnlibry.sloughmobileapps.co.uk/blog">Blogs</a></li>
        </li>
