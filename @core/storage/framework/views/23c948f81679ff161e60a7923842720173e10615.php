                    ...
                    <?php if(empty(auth('web')->user()->subscribedSeller)): ?>
                        <div class="col-lg-12 mt-1">
                                <div class="alert alert-warning d-flex justify-content-between">
                                    <strong style="font-size: 16px"><?php echo e(__('you must have to subscribe any of our package in booking to start providing your services.')); ?></strong>
                                            ...
                                            <div class="dashboard_recentOrder__item__flex">
                                                <div class="dashboard_recentOrder__item__service">
                                                    ...
                                                    <div class="dashboard_recentOrder__item__service__contents">
                                                        <a href="<?php echo e(route('seller.order.details', $order->id)); ?>" class="dashboard_recentOrder__item__service__id"><span><?php echo e(__('Booking ID:')); ?></span> <?php echo e($order->id); ?></a>
                                                        ...
                                                        <p class="dashboard_recentOrder__item__service__buyer mt-2">
                                                            ...
                                                            <?php echo e(__('Reader:')); ?>   <a href="<?php echo e(route('about.buyer.profile',optional($order->buyer)->username)); ?>"> <?php echo e(optional($order->buyer)->name); ?> </a>
                                                        </p>
                                                    </div>
                                                </div>
                            ...
                            <div class="dashboard_promo__row row_col_2 mt-2">
                                <div class="dashboard_promo__col dashboard_promo__child">
                                    <div class="dashboard_promo bg-white">
                                        <div class="dashboard_promo__flex">
                                            <div class="dashboard_promo__contents">
                                                <span class="dashboard_promo__subtitle"><?php echo e(__('Booking')); ?></span>
                                ...
                                <div class="dashboard_promo__col dashboard_promo__child">
                                    <div class="dashboard_promo bg-white">
                                        <div class="dashboard_promo__flex">
                                            <div class="dashboard_promo__contents">
                                                <span class="dashboard_promo__subtitle"><?php echo e(__('Total Reader')); ?></span>
                            ...
                            <div class="single-flex-middle margin-top-40">
                                <div class="line-charts-wrapper">
                                    <div class="line-top-contents">
                                        <h4 class="dashboard_table__title"><?php echo e(__('Total Booking Overview')); ?></h4>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\humnlibry\@core\resources\views/frontend/user/seller/dashboard/partials/dashboard-two.blade.php ENDPATH**/ ?>