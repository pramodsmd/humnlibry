                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="dashboard-settings margin-top-40">
                                ...
                                <div class="col-sm-6 notice-board info-board">
                                    <p class="text-info"><?php echo e(__('Edit service will need to admin approval to activate.')); ?></p>
                                </div>
                                 <div class="col-sm-6 notice-board info-board update-info" >
                                    <p class="text-warning"><?php echo e(__('You can not update the services which have on going Bookings.')); ?></p>
                                </div>
                                </div>
                            </div>
                        </div>
...
} elseif ($_instance->childHasBeenRendered('NvSBqcE')) {
    $componentId = $_instance->getRenderedChildComponentId('NvSBqcE');
    $componentTag = $_instance->getRenderedChildComponentTagName('NvSBqcE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NvSBqcE');
} else {
    $response = \Livewire\Livewire::mount('edit-service', ['editServiceId' => $edit_service_id,'edit_service_id' => $edit_service_id]);
    $html = $response->html();
    $_instance->logRenderedChild('NvSBqcE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/frontend/user/seller/services/partials/edit-service-two.blade.php ENDPATH**/ ?>