                ...
                <form method="POST" action="<?php echo e(route('admin.login')); ?>">
                    ...
                    <div class="login-form-head">
                        <div class="logo-wrapper" style="margin-bottom: 40px;">
                            <span style="width:40%important"><?php echo render_image_markup_by_attachment_id(get_static_option('site_logo')); ?></span>
                        </div>
...
<?php echo $__env->make('layouts.login-screens', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/auth/admin/login.blade.php ENDPATH**/ ?>