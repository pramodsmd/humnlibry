                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="dashboard_table__main__actions">
                                                    <a href="<?php echo e(route('seller.order.details.notification',$notification->id)); ?>" class="icon"><i class="fa-regular fa-eye"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="list-order" href="#">
                                                    <span class="order-icon"> <i class="las la-check-circle"></i> </span>
                                                    <?php echo e(__($notification->data['order_message'])); ?> #<?php echo e($notification->data['service_id']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/frontend/user/seller/notification/partials/notification-two.blade.php ENDPATH**/ ?>