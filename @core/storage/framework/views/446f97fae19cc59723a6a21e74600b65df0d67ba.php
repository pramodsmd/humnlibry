        ...
        <div class="dashboard__body">
            <div class="dashboard__inner">
                            ...
                            <div class="dashboard__headerGlobal__flex">
                                <div class="dashboard__headerGlobal__content">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        <h4 class="dashboard_table__title"><?php echo e(__('Search Booking Module')); ?></h4> <i class="las la-angle-down search_by_all"></i>
                                    </button>
                                </div>
                                                ...
                                                <div class="single-settings">
                                                    <div class="single-dashboard-input">
                                                        ...
                                                        <div class="row g-4 mt-3">
                                                            ...
                                                            <div class="col-lg-4 col-sm-6">
                                                                <div class="single-info-input">
                                                                    <label for="order_status" class="info-title"> <?php echo e(__('Booking Status')); ?> </label>
                                                                    <select name="order_status">
                                                                        <option value=""><?php echo e(__('Select Booking Status')); ?></option>
                ...
                <div class="dashboard_table__wrapper dashboard_border  padding-20 radius-10 bg-white">
                    ...
                    <?php else: ?>
                        <h4 class="dashboards-title mb-3"><?php echo e(__('All Service Bookings')); ?></h4>
                    <?php endif; ?>
...
<?php endif; ?>
                    ...
                    <div class="dashboard_table__main custom--table mt-4">
                        <table>
                            <thead>
                            <tr>
                                <th><?php echo e(__('Booking item')); ?></th>
                                ...
                                <th><?php echo e(__('Booking Complete Request')); ?></th>
                                        ...
                                        <div class="dashboard_table__main__order__flex">
                                            ...
                                            <div class="dashboard_table__main__order__contents">
                                                ...
                                                <span class="dashboard_table__main__order__contents__subtitle mt-2">
                                                    <a href="javascript:void(0)" class="dashboard_table__main__order__contents__id"> <strong class="text-dark"><?php echo e(__('Booking ID:')); ?></strong> <?php echo e($order->id); ?></a> ,
                                                ...
                                                <span><strong><?php echo e(__('Booking Date:')); ?></strong>  <?php echo e(Carbon\Carbon::parse( strtotime($order->created_at))->format('d/m/y')); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModal"><?php echo e(__('Create Booking Complete Request')); ?></h5>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-info mt-2"><?php echo e(__('Completed: Booking is completed and closed.')); ?></p>
                        </div>
...
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/frontend/user/seller/order/partials/orders-two.blade.php ENDPATH**/ ?>