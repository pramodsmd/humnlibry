        ...
        <div class="dashboard__inner">
            ...
            <div class="dashboard_table__wrapper dashboard_border  padding-20 radius-10 bg-white">
                <div class="dashboard_table__title__flex">
                    <h4 class="dashboards-title"> <?php echo e(__('Report Details')); ?> </h4>
                </div>
                            ...
                            <div class="card-body">
                                <div class="gig-chat-message-heading">
                                    <div class="header-wrap d-flex justify-content-between">
                                        ...
                                        <a class="btn btn-primary btn-xs" href="<?php echo e(route('seller.order.report.list')); ?>"><?php echo e(__('All Reports')); ?></a>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/resources/views/frontend/user/seller/report/partials/report-chat-two.blade.php ENDPATH**/ ?>