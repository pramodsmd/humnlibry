                                    ...
                                    <div class="col-lg-8 margin-top-30">
                                        <div class="service-overview-wrapper padding-bottom-30">
                                            ...
                                            <div class="overview-single padding-top-60 extra-services">
                                                <h4 class="title"><?php echo e(get_static_option('service_additional_attribute_title') ?? __('Upgrade your booking with extras')); ?>
                        ...
                        <!-- Information -->
                            <fieldset class="padding-top-20 padding-bottom-100 confirm-information">
                                <div class="Info-overview padding-top-30">
                                    ...
                                    <div class="single-info-overview margin-top-30">
                                        <div class="single-info-input">
                                            <label class="info-title"><?php echo e(__('Booking Note*')); ?> </label>
                                            <textarea class="form--control textarea--form" name="order_note" id="order_note" placeholder="<?php echo e(__('Type Booking Note')); ?>"></textarea>
                                        ...
                                        <div class="confirm-overview-left margin-top-30">
                                            <?php if($service_details_for_book->is_service_online != 1): ?>
                                                <div class="single-confirm-overview">
                                                    ...
                                                    <div class="single-confirm margin-top-30">
                                                        <h3 class="titles"><?php echo e(__('booking Location')); ?></h3>
                                            ...
                                            <div class="booking-info padding-top-60">
                                                ...
                                                <div class="booking-details">
                                                    <ul class="booking-list">
                                                        ...
                                                        <li class="lists">
                                                            <span class="list-span"><?php echo e(__('Booking Note:')); ?></span>
                                        ...
                                        <div class="service-overview-summery">
                                            ...
                                            <div class="overview-summery-contents">
                                                ...
                                                <div class="btn-wrapper">
                                                    <?php if($service_details_for_book->is_service_online == 1): ?>
                                                        <?php if(Auth::guard('web')->check()): ?>
                                                            <button type="submit" class="cmn-btn btn-appoinment btn-bg-1"><?php echo e(get_static_option('service_order_confirm_title') ?? __('Pay & Confirm Your Booking')); ?> </button>
                                                        <?php else: ?>
                                                            ...
                                                            <small class="text-danger"><?php echo e(__('Must login to create booking for online services')); ?></small>
                                                        <?php endif; ?>
                                                    <?php else: ?>
                                                        <button type="submit" class="cmn-btn btn-appoinment btn-bg-1"><?php echo e(get_static_option('service_order_confirm_title') ?? __('Pay & Confirm Your Booking')); ?> </button>
                                                    <?php endif; ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/frontend/pages/services/service-book.blade.php ENDPATH**/ ?>