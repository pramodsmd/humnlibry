            ...
            <div class="dashboard__inner">
                ...
                <div class="dashboard_table__wrapper dashboard_border  padding-20 radius-10 bg-white">
                    <div class="dashboard_table__title__flex">
                        <h4 class="dashboards-title"> <?php echo e(__('Ticket Details')); ?> </h4>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="gig-chat-message-heading">
                                        ...
                                        <div class="gig-order-info">
                                            ...
                                            <p><strong><?php echo e(__('Booking ID:')); ?></strong> #<?php echo e($ticket_details->order_id); ?></p>
                                        </div>
...
<?php endif; ?>
                                            ...
                                            <form action="<?php echo e(route('buyer.support.ticket.message.send')); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <button class="btn-primary btn btn-md mt-3" type="submit"><?php echo e(__('Send Message')); ?></button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/frontend/user/buyer/support-ticket/partials/view-ticket-two.blade.php ENDPATH**/ ?>