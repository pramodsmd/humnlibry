        ...
        <div class="dashboard__bottom mt-5">
            <ul class="dashboard__bottom__list dashboard-list">
                ...
                <li class="dashboard__bottom__list__item <?php if(request()->is('seller/pending-orders')): ?> active <?php endif; ?>">
                    <a href="<?php echo e(route('seller.pending.orders')); ?>"> <i class="las la-tasks"></i> <?php echo e(__('Booking Pending')); ?> </a>
                </li>

                <li class="dashboard__bottom__list__item <?php if(request()->is('seller/orders*')): ?> active <?php endif; ?>">
                    <a href="<?php echo e(route('seller.orders')); ?>"><i class="las la-list-alt"></i> <?php echo e(__('All Service Bookings')); ?> </a>
                </li>
...
</div><?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/frontend/user/seller/partials/sidebar-two.blade.php ENDPATH**/ ?>