...
} elseif ($_instance->childHasBeenRendered('YaTevGi')) {
    $componentId = $_instance->getRenderedChildComponentId('YaTevGi');
    $componentTag = $_instance->getRenderedChildComponentTagName('YaTevGi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YaTevGi');
} else {
    $response = \Livewire\Livewire::mount('edit-service', ['editServiceId' => $edit_service_id,'edit_service_id' => $edit_service_id]);
    $html = $response->html();
    $_instance->logRenderedChild('YaTevGi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/resources/views/frontend/user/seller/services/partials/edit-service-two.blade.php ENDPATH**/ ?>