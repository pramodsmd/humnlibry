                                ...
                                <?php if(get_static_option('seller_register_on_off') === 'on'): ?>
                                    <li data-tab="tab_one" class="is_user_seller <?php if($reg_type === 'seller'): ?> active <?php endif; ?>">
                                        <div class="single-tabs-registration">
                                            ...
                                            <div class="contents">
                                                <h4 class="title" id="seller"> <?php echo e(get_static_option('human_book') ?? __('Human Book')); ?></h4>
                                            </div>
                                        </div>
                                    </li>
                                <?php endif; ?>
                                <?php if(get_static_option('buyer_register_on_off') === 'on'): ?>
                                    <li data-tab="tab_two" class="<?php if($reg_type === 'buyer'): ?> active <?php endif; ?> is_user_buyer">
                                        <div class="single-tabs-registration">
                                            ...
                                            <div class="contents">
                                                <h4 class="title" id="buyer"> <?php echo e(get_static_option('human_reader') ?? __('Human Reader')); ?></h4>
                                            </div>
                                        </div>
                                    </li>
                                <?php endif; ?>
...
<?php echo $__env->make('frontend.frontend-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/frontend/user/register.blade.php ENDPATH**/ ?>