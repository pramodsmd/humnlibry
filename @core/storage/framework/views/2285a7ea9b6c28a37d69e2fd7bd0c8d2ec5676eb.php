                       ...
                       ?>
                        ...
                        <div class="dashboard__header__notification">
                            ...
                            <?php if(Auth::guard('web')->check() && Auth::guard('web')->user()->user_type==1): ?>
                             <span class="dashboard__header__notification__number"><?php echo e($notificationcount); ?></span>
                            <?php else: ?>
                                                ...
                                                <li class="dashboard__header__notification__wrap__list__item">
                                                    <div class="dashboard__header__notification__wrap__list__flex">
                                                        <a class="dashboard__header__notification__wrap__list__contents__title"
                                                           href="<?php echo e(route('buyer.order.details.notification',$notification->id)); ?>">
                                                        ...
                                                        <div class="dashboard__header__notification__wrap__list__contents">
                                                                <?php echo e($data->order_message); ?> #<?php echo e($data->order_id); ?>
                                            ...
                                            <!--seller order notification -->
                                                <?php if(isset($notification->data['order_id'])): ?>
                                                    <li class="dashboard__header__notification__wrap__list__item">
                                                        <div class="dashboard__header__notification__wrap__list__flex">
                                                            <a class="dashboard__header__notification__wrap__list__contents__title"
                                                               href="<?php echo e(route('seller.order.details.notification',$notification->id)); ?>">
                                                ...
                                                <?php endif; ?>
                                                 ...
                                                 <?php if($notification->data['order_id']==null): ?>
                                                    <li class="dashboard__header__notification__wrap__list__item">
                                                        <div class="dashboard__header__notification__wrap__list__flex">
                                                            <a class="dashboard__header__notification__wrap__list__contents__title"
                                                               href="#">
                                                            <div class="dashboard__header__notification__wrap__list__icon"> <i class="las la-bell"></i> </div>
                                                            <div class="dashboard__header__notification__wrap__list__contents">
                                                                    <?php echo e($notification->data['order_message']); ?> #<?php echo e($notification->data['service_id']); ?>
...
</div><?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/frontend/user/buyer/header/buyer-header.blade.php ENDPATH**/ ?>