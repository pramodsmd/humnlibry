                                        ...
                                        <?php if(!empty(get_static_option($gateway.'_gateway'))): ?>
                                            <option value="<?php echo e($gateway); ?>" <?php if(get_static_option('site_default_payment_gateway') == $gateway): ?> selected <?php endif; ?>>
                                                <?php if($gateway=='stripe'): ?>
                                                 <?php echo e(ucwords(str_replace('_',' ','Debit/Credit Card'))); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/Modules/Subscription/Resources/views/backend/seller-subscriptions.blade.php ENDPATH**/ ?>