...
} elseif ($_instance->childHasBeenRendered('ojRXufv')) {
    $componentId = $_instance->getRenderedChildComponentId('ojRXufv');
    $componentTag = $_instance->getRenderedChildComponentTagName('ojRXufv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ojRXufv');
} else {
    $response = \Livewire\Livewire::mount('add-service', []);
    $html = $response->html();
    $_instance->logRenderedChild('ojRXufv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/resources/views/frontend/user/seller/services/partials/add-service-two.blade.php ENDPATH**/ ?>