                    ...
                    <div class="dashboard_table__title__flex">
                        ...
                        <div class="btn-wrapper" data-bs-toggle="modal" data-bs-target="#openTicket">
                            <a href="javascript:void(0)"
                               ...
                               data-bs-target="#ticketModal"><i class="fa-solid fa-plus"></i> <?php echo e(__('Create Ticket For A Booking' )); ?></a>
                        </div>
                    </div>
                    ...
                    <div class="custom-form">
                        <form action="<?php echo e(route('buyer.support.ticket.new')); ?>" method="post">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    <div class="single-input">
                                        <label for="ticketTitle" class="label_title"><?php echo e(__('Select Booking')); ?></label>
                                        <div class="single-input-select radius-10">
                                            <select class="select2_activation" name="order_id">
                                                <option value=""><?php echo e(__('Select Booking')); ?></option>
                                                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($order->id); ?>"><?php echo e(__('Booking ID#')); ?> <?php echo e($order->id); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/frontend/user/buyer/support-ticket/partials/tickets-two.blade.php ENDPATH**/ ?>