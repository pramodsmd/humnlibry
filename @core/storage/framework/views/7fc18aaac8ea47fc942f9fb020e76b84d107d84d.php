                    ...
                    <?php
                        $unread_count = 0;
                             ...
                             try{
                                ...
                                $admin_unread_notifications = \App\AdminNotification::where('status', 0)->latest()->take(5)->get();
                             }catch(\Exception $e){  }
                                ...
                                <div class="slimScrollDiv">
                                    <div class="nofity-list">
                                        ...
                                        <?php $__currentLoopData = $admin_unread_notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <a href="<?php echo e(route('admin.orders.details.notification', $data->id)); ?>" class="notify-item">
                                            ...
                                            <a href="<?php echo e(route('admin.service.view.details.notificationupdate', $data->id)); ?>" class="notify-item">
                                                <div class="notify-thumb"><i class="ti-check-box btn-dark"></i></div>
                                                <div class="notify-text">
                                                    <p>  
                                        ...
                                        <?php $__currentLoopData = $admin_unread_notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <a href="<?php echo e(route('admin.ticket.details', $data->ticket_id)); ?>" class="notify-item">
                                                <div class="notify-thumb"><i class="ti-check-box btn-dark"></i></div>
                                                <div class="notify-text">
                                                    <p><?php echo e(__('New booking ticket')); ?> #<?php echo e($data->ticket_id ?? ''); ?></p>
                                                    <span> <?php echo e(\Carbon\Carbon::parse($data->created_at)->diffForHumans()); ?> </span>
                                                </div>
                                            </a>
                                              <?php endif; ?>
...
<?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/backend/admin-master.blade.php ENDPATH**/ ?>