        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="dashboard-settings margin-top-40">
                    <h3 class="dashboards-title"> <?php echo e(__('Add Service Attributes')); ?> </h3>
                </div>
            </div>
            <div class="col-lg-6 mt-5">
                <div class="dashboard-switch-single">
                    <input class="custom-switch is_service_online" id="is_service_online" type="checkbox"/>
                    <label class="switch-label" for="is_service_online"><?php echo e(__('Is Service Online:')); ?></label>
                </div>
            </div>
        </div>
        <div class="row">
...
<?php endif; ?>
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('admin.add.service.attributes')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    ...
                    <input type="hidden" name="seller_id"  id="seller_id" value="<?php echo e($latest_service->seller_id); ?>">
                    ...
                    <div class="row">
                        <div class="col-xl-4 margin-top-50">
                            <div class="edit-service-wrappers">
                                ...
                                <div class="content-edit margin-top-40">
                                    <h5 class="title"> <?php echo e($latest_service->title); ?> </h5>
                                ...
                                <div class="btn-wrapper margin-top-40">
                                    <button type="submit" class="btn btn-success"><?php echo e(__('Save & Publish')); ?></button>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-8 margin-top-50">
                            ...
                            <div class="single-settings margin-top-40">
                                <h5 class="input-title"> <?php echo e(__('Add Aditional Services')); ?> </h5>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/backend/pages/services/admin-service/add_service_attributes.blade.php ENDPATH**/ ?>