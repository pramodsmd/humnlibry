<?php if(Auth::guard('web')->check() && Auth::guard('web')->user()->user_type === 1): ?>
    ...
    <?php endif; ?><?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/components/livechat/widget-markup.blade.php ENDPATH**/ ?>