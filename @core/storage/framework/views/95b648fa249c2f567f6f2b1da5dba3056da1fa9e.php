...
<?php else: ?>
    ...
    <div class="login-account">
        <a class="accounts" href="<?php echo e(route('user.login')); ?>"> <span class="account"><?php echo e(__('Login')); ?></span> <i class="las la-user"></i> </a>
        <!--<ul class="account-list-item mt-2">-->
...
<?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/components/frontend/user-menu.blade.php ENDPATH**/ ?>