...
<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Booking Success')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('page-meta-data'); ?>
    <title><?php echo e(__('Booking Success')); ?></title>
<?php $__env->stopSection(); ?>
                ...
                <form id="msform" class="msform">
                    ...
                    <fieldset class="padding-top-80 padding-bottom-100">
                        <div class="form-card successful-card">
                            ...
                            <h5 class="purple-text text-center"><?php echo e(get_static_option('Your Booking Successfully Completed') ?? __('Your Booking Successfully Completed')); ?></h5>
                            <div class="btn-wrapper margin-top-35">
                                <h4 class="mb-3"><?php echo e(get_static_option('Your Booking Details') ?? __('Your Booking Details')); ?></h4>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php else: ?>
                                                 <?php echo e(__(ucwords(str_replace("_", " ", $order_details->payment_gateway)))); ?>
                            ...
                            <div class="btn-wrapper text-center margin-top-35">
                                ...
                                <?php if(auth('web')->check()): ?>
                                    ...
                                    <a href="<?php echo e(route($route_prefix.'.orders')); ?>" class="cmn-btn btn-bg-1"><?php echo e(__('All Bookings')); ?></a>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/frontend/payment/payment-success.blade.php ENDPATH**/ ?>