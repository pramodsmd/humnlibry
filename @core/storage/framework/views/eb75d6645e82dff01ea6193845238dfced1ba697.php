                                    ...
                                    <div class="single-flex-middle-inner">
                                        <div class="line-charts-wrapper margin-top-40">
                                            ...
                                            <div class="line-top-contents">
                                                <h5 class="earning-title"><?php echo e(__('Service Provider Details')); ?></h5>
                                            </div>
                                            ...
                                            <div class="single-checbox">
                                                ...
                                                <div class="checkbox-inlines">
                                                    <label><strong><?php echo e(__('Payment Gateway:')); ?> </strong>
                                                         <?php if($order_details->payment_gateway=="stripe"): ?>
                                                       
                                                        <?php echo e(__('Debit/Credit card')); ?>

                                                         <?php else: ?>
                                                        <?php echo e(ucwords(str_replace("_", " ", $order_details->payment_gateway))); ?>
                                            ...
                                            <div class="line-top-contents">
                                                <h5 class="earning-title"><?php echo e(__('Booking Details')); ?></h5>
                                            </div>
                                            <div class="single-checbox">
                                                <div class="checkbox-inlines">
                                                    <label><strong><?php echo e(__('Booking ID:')); ?> </strong><?php echo e($order_details->id); ?>

                                                    </label>
                                                </div>
                                                <div class="checkbox-inlines">
                                                    <label><strong><?php echo e(__('Booking Status: ')); ?></strong>
                                    ...
                                    <div class="single-flex-middle mt-4">
                                        <div class="single-flex-middle-inner">
                                            <div class="line-charts-wrapper oreder_details_rtl margin-top-40">
                                                ...
                                                <span class="info-text d-block mb-4"><?php echo e(__('This is not included in the main service booking calculation')); ?></span>
                                                <div>
                                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php if($ex_service->payment_status === 'pending'): ?>
                                                                    ...
                                                                    <?php if($ex_service->status === 2 && $ex_service->payment_status === 'pending'): ?>
                                                                        <span class="btn btn-dark"><?php echo e(__('Wait for admin approval')); ?></span>
                                                                    <?php endif; ?>
                                                                <?php else: ?>
                                ...
                                <?php if(!empty($order_declines_history->count() >= 1)): ?>
                                    <div class="single-flex-middle mt-4">
                                        <div class="single-flex-middle-inner">
                                            <div class="line-charts-wrapper oreder_details_rtl margin-top-40">
                                                <div class="line-top-contents">
                                                    <h5 class="earning-title"><?php echo e(__('Booking Decline History')); ?></h5>
                                                </div>
                                                <table class="table table-bordered">
                                                    <thead>
                                                    <tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/frontend/user/buyer/order/partials/order-details-two.blade.php ENDPATH**/ ?>