                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="dashboard-settings margin-top-40">
                            <h4 class="dashboards-title"> <?php echo e(__('Create Job Post')); ?> </h4>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="dashboard-settings margin-top-40">
                            <strong class="online_checkbox__title"><?php echo e(__('Check If Job is Online')); ?></strong>
                            ...
                            <div class="single-settings">
                                    <div class="single-dashboard-input mt-4">
                                        <div class="single-info-input">
                                            <label for="title" class="info-title"> <?php echo e(__('Job Title')); ?> <span class="text-danger">*</span> </label>
                                    ...
                                    <div class="single-dashboard-input mt-2">
                                        <div class="single-info-input">
                                            <label for="price" class="info-title"> <?php echo e(__('Budget')); ?> <span class="text-danger">*</span> </label>
                                            <input class="form--control" value="<?php echo e(old('price')); ?>" name="price" id="price" type="number" placeholder="<?php echo e(__('Add Price')); ?>">
                                        </div>

                                        <div class="single-info-input">
                                            <label for="dead_line" class="info-title"> <?php echo e(__('Deadline to Apply for this job')); ?> <span class="text-danger">*</span> </label>
                    ...
                    <div class="col-xxl-6">
                        <div class="single-dashboard-input">
                            <div class="single-info-input margin-top-30">
                                <label for="category" class="info-title"> <?php echo e(__('Select Category')); ?> <span class="text-danger">*</span> </label>
                            ...
                            <div class="single-info-input margin-top-30 sub_category_wrapper">
                                <label for="subcategory" class="info-title"> <?php echo e(__('Select Subcategory')); ?> <span class="text-danger">*</span> </label>
                ...
                <div class="row">
                    <div class="col-xxl-6">
                        <div class="single-dashboard-input">
                            <div class="single-dashboard-input">
                                <div class="single-info-input">
                                    <label for="description" class="info-title"> <?php echo e(__('Job Description')); ?> <span class="text-danger">*</span> </label>
                            ...
                            <div class="single-dashboard-input">
                                ...
                                <div class="single-info-input mt-4">
                                    <div class="btn-wrapper text-end">
                                        <button type="submit" class="dashboard_table__title__btn btn-bg-1 radius-5" style="border: none">  <?php echo e(__('Create Job Post')); ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/Modules/JobPost/Resources/views/frontend/buyer/partials/add-job-two.blade.php ENDPATH**/ ?>