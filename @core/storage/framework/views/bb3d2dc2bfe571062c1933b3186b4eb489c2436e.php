<script>
    ...
    <script src="<?php echo e(asset('./@core/public/js/app.js')); ?>"></script><?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/components/livechat/widget-js.blade.php ENDPATH**/ ?>