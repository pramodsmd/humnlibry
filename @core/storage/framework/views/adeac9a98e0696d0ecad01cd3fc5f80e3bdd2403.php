    ...
    <div class="dashboard-close-main">
        ...
        <div class="dashboard-bottom margin-top-35 margin-bottom-50">
            <ul class="dashboard-list ">
                ...
                <li class="list <?php if(request()->is('buyer/notification/all-notifications*')): ?> active <?php endif; ?>">
...
</div><?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/frontend/user/buyer/partials/sidebar.blade.php ENDPATH**/ ?>