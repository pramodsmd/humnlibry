                                                ...
                                                <?php if($request_details->is_hired != 1): ?>
                                                    <a href="#0" class="edit_offer_price"
                                                       ...
                                                       data-expected_salary="<?php echo e($request_details->expected_salary); ?>"                                                     >
                                                        <span class="dash-icon dash-edit-icon color-1" title="<?php echo e(__('Change offer price')); ?>"> <i class="las la-edit btn btn-warning"></i> </span>
                                                    </a>
                                                <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/Modules/JobPost/Resources/views/frontend/seller/partials/conversation-two.blade.php ENDPATH**/ ?>