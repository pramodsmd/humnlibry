    ...
    <div class="main-content-inner">
        <div class="row">
            <div class="col-xl-3 col-md-6 margin-top-30 orders-child">
                <a href="<?php echo e(route('admin.all.user')); ?>">
            ...
            <div class="col-xl-3 col-md-6 margin-top-30 orders-child">
            <a href="<?php echo e(route('admin.frontend.seller.all')); ?>">
                <div class="single-orders">
                    <div class="orders-shapes">
                    ...
                    <div class="orders-flex-content">
                        ...
                        <div class="contents">
                            ...
                            <span class="order-para"> <?php echo e(__('Total Books')); ?> </span>
                        </div>
                    </div>
                </div>
                </a>
                ...
                <div class="single-orders">
                    ...
                    <div class="orders-flex-content">
                        ...
                        <div class="contents">
                            ...
                            <span class="order-para"> <?php echo e(__('Total Readers')); ?></span>
                        </div>
                    </div>
                </div>
                </a>
                ...
                <div class="single-orders">
                    ...
                    <div class="orders-flex-content">
                        ...
                        <div class="contents">
                            ...
                            <span class="order-para"><?php echo e(__('Booking Pending')); ?> </span>
                        </div>
                    </div>
                </div>
                </a>
            ...
            <div class="col-xl-3 col-md-6 margin-top-30 orders-child">
               <a href="<?php echo e(route('admin.payout.request.all')); ?>">
                <div class="single-orders">
                    <div class="orders-shapes">
                        <img src="<?php echo e(asset('assets/frontend/img/static/orders-shapes3.png')); ?>" alt="">
                    </div>
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-6">
                <h4 class="mb-3 earning-title"><?php echo e(__('Most Booked Services')); ?></h4>
                <div class="table-wrap table-responsive">
                    <table class="table table-bordered">
                        <thead>
                        <th><?php echo e(__('ID')); ?></th>
        ...
        <div class="row mt-5">
            <div class="col-md-6">
                <div class="line-charts-wrapper">
                    <div class="line-top-contents">
                        <h5 class="earning-title"><?php echo e(__('Monthly Booking Overview')); ?></h5>
                    </div>
                    <div class="line-charts">
            ...
            <div class="col-md-6">
                <div class="line-charts-wrapper">
                    <div class="line-top-contents">
                        <h5 class="earning-title"><?php echo e(__('Daily Booking Overview Last 30 Days')); ?></h5>
                    </div>
                    <div class="line-charts">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/backend/admin-home.blade.php ENDPATH**/ ?>