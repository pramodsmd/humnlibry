        ...
        <div class="dashboard__bottom mt-5">
            <ul class="dashboard__bottom__list dashboard-list">
                ...
                <?php if(moduleExists('JobPost')): ?>
                    ...
                    <li class="dashboard__bottom__list__item <?php if(request()->is('buyer/job/request/all*')): ?> active <?php endif; ?> ">
                         <?php
...
</div><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/resources/views/frontend/user/buyer/partials/sidebar-two.blade.php ENDPATH**/ ?>