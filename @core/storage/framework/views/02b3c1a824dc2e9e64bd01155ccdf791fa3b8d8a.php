...
} elseif ($_instance->childHasBeenRendered('bYGUq6W')) {
    $componentId = $_instance->getRenderedChildComponentId('bYGUq6W');
    $componentTag = $_instance->getRenderedChildComponentTagName('bYGUq6W');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bYGUq6W');
} else {
    $response = \Livewire\Livewire::mount('add-service', []);
    $html = $response->html();
    $_instance->logRenderedChild('bYGUq6W', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sloughmobileapps/public_html/humnlibry.sloughmobileapps.co.uk/@core/resources/views/frontend/user/seller/services/partials/add-service-two.blade.php ENDPATH**/ ?>