                                            ...
                                            <div class="notification-icon icon">
                                                <?php if(Auth::guard('web')->check()): ?>
                                                    ...
                                                    <span class="notification-number">
                                                          <?php $order_count =Auth()->user()->unreadNotifications()->count(); ?>
                        ...
                        <?php if(moduleExists('Subscription') && $commissionGlobal->system_type == 'subscription' ): ?>
                            ...
                            <?php else: ?>
                                ...
                                <?php if(!empty(Auth::guard('web')->user()->subscribedSeller)): ?>
                                    <?php if(Carbon\Carbon::parse(auth('web')->user()->subscribedSeller->expire_date)->gt(Carbon\Carbon::today())): ?>
                                        <div class="col-lg-12 mt-1">
                                        <div class="alert alert-warning d-flex justify-content-between">
...
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/resources/views/frontend/user/seller/dashboard/partials/dashboard-one.blade.php ENDPATH**/ ?>