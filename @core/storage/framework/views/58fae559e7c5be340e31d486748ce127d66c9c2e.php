...
} elseif ($_instance->childHasBeenRendered('uOBzSoH')) {
    $componentId = $_instance->getRenderedChildComponentId('uOBzSoH');
    $componentTag = $_instance->getRenderedChildComponentTagName('uOBzSoH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('uOBzSoH');
} else {
    $response = \Livewire\Livewire::mount('edit-service', ['editServiceId' => $edit_service_id,'edit_service_id' => $edit_service_id]);
    $html = $response->html();
    $_instance->logRenderedChild('uOBzSoH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\humnlibry\@core\resources\views/frontend/user/seller/services/partials/edit-service-two.blade.php ENDPATH**/ ?>