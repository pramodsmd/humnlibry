                        ...
                        <div class="dashboard__headerContents__left">
                            ...
                            <?php if(moduleExists('Subscription') && $commissionGlobal->system_type == 'subscription'): ?>
                                  <?php if(!empty(auth('web')->user()->subscribedSeller)): ?>
                                            <?php if(Carbon\Carbon::parse(auth('web')->user()->subscribedSeller->expire_date) <= \Carbon\Carbon::today()): ?>
                                             <div class="col-lg-12">
                                                <div class="alert alert-warning d-flex justify-content-between"><?php echo e(__('your package has been expired, please renew it')); ?>
                                                    ...
                                                    <a href="<?php echo e(url('/price-plan')); ?>" target="_self" class="dashboard_table__title__btn btn-bg-1 radius-5"><?php echo e(__('view packages')); ?></a>
                                                </div>
                                            </div>
                                          <?php else: ?>
                                    ...
                                    <?php else: ?>
                                   <div class="col-lg-12">
                                    <div class="alert alert-warning d-flex justify-content-between"><?php echo e(__('you must have to subscribe any of our package in booking to start provide your services.')); ?>
...
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\humnlibry\@core\resources\views/frontend/user/seller/services/partials/services-two.blade.php ENDPATH**/ ?>