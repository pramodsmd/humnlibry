        ...
        if($request->isMethod('post')){
            ...
            Subscription::create([
               ...
               // 'connect' => $request->connect,
                ...
                'profile_searchable' => $request->profile_searchable,
                'booking_availability' => $request->booking_availability,
                'booking_calendar' => $request->booking_calendar,
                'booking_counter' => $request->booking_counter,
               // 'job' => $request->job,
                'about_subscription'=>$request->about_subscription,
                'status' => 1,
            ]);
