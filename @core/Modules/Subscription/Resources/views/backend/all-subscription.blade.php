                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul>
                                                ...
                                                <li><strong>{{__('book provider Using This Subscription')}}: </strong>{{optional($data->seller)->count()}}</li>
                                            </ul>
                        ...
                        <form action="{{route('admin.subscription.all')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="about_subscription" id="editor" class="form-control"  value="{{ old('about_subscription') }}" placeholder="{{__('About Subscription')}}"></textarea>
                                </div>
                                <div class="form-group">
