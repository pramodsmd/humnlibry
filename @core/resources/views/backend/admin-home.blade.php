...
@section('content')
    ...
    <div class="main-content-inner">
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6 margin-top-30 orders-child">
            <a href="{{ route('admin.frontend.seller.all') }}">
                <div class="single-orders">
                    <div class="orders-shapes">
                ...
                <div class="single-orders">
                    ...
                    <div class="orders-flex-content">
                        ...
                        <div class="contents">
                            ...
                            <span class="order-para"> {{ __('Total Readers') }}</span>
                        </div>
                    </div>
                </div>
                </a>
            ...
            <div class="col-xl-3 col-md-6 margin-top-30 orders-child">
               <a href="{{ route('admin.payout.request.all') }}">
                <div class="single-orders">
                    <div class="orders-shapes">
                        <img src="{{ asset('assets/frontend/img/static/orders-shapes3.png') }}" alt="">
                    </div>
        ...
        <div class="row mt-5">
            <div class="col-md-6">
                <div class="line-charts-wrapper">
                    <div class="line-top-contents">
                        <h5 class="earning-title">{{ __('Monthly Booking Overview') }}</h5>
                    </div>
                    <div class="line-charts">
            ...
            <div class="col-md-6">
                <div class="line-charts-wrapper">
                    <div class="line-top-contents">
                        <h5 class="earning-title">{{ __('Daily Booking Overview Last 30 Days') }}</h5>
                    </div>
                    <div class="line-charts">
