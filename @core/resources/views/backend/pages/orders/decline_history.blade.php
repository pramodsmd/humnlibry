...
@section('site-title')
    {{__('Booking Complete Request Decline')}}
@endsection
                    ...
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <div class="left-content">
                                <h4 class="header-title">{{__('Booking Complete Request Decline List')}}  </h4>
                                <small class="text-info py-2">{{ __('These are the Booking Complete request decline lists decline by the reader') }}</small>
                            </div>
                        </div>
                            ...
                            <table class="table table-default">
                                ...
                                @foreach($decline_histories as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-info" href="{{ route('admin.orders.details',$data->id) }}">{{ __('Booking Details') }}</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
