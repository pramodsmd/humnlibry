        ...
        <div class="menu-inner">
            <nav>
                <ul class="metismenu" id="menu">
                    ...
                    @canany(['amount-settings','all-seller'])
...
{{--                                @endcan--}}
                                ...
                                @can('order-create-setting')
                                    <li class="{{ active_menu('admin-home/services/order-create-settings') }}"><a
                                      href="{{ route('admin.order.create.settings') }}">{{ __('Booking Create Settings') }}</a></li>
                                @endcan
                            </ul>
                        </li>
                    @endcanany
                    ...
                    <li
                        ...
                        <a href="javascript:void(0)" aria-expanded="true"><i class="ti-list-ol"></i>
                            <span>{{ __('All Bookings') }}</span></a>
                        <ul class="collapse">
                            @can('order-list')
                            <li class="{{ active_menu('admin-home/orders') }}">
                                <a href="{{ route('admin.orders') }}">{{ __('All Bookings') }}
                                    @if($all_order>=1)
                            ...
                            <li class="{{ active_menu('admin-home/orders/cancel-orders') }}">
                                <a href="{{ route('admin.orders.cancel') }}">{{ __('Cancelled Bookings') }}
                                    @if($cancel_order>=1)
                            ...
                            <li class="{{ active_menu('admin-home/orders/order-success-settings') }}">
                                <a href="{{ route('admin.order.success.settings') }}">{{ __('Booking Success Settings') }}</a>
                            </li>
                            @endcan
                            @can('order-request-complete')
                                <li class="{{ active_menu('admin-home/orders/order-request-complete') }}">
                                    <a href="{{ route('admin.order.complete.request') }}">{{ __('Booking Request Complete') }}</a>
                                </li>
                            @endcan
                                @can('order-request-complete')
                            ...
                            @can('extra-orders')
                                <li class="{{ active_menu('admin-home/orders/extra/orders') }}">
                                    <a href="{{ route('admin.extra.orders') }}"><i class="ti-list-ol"></i> {{ __('Extra Bookings') }}</a>
                                </li>
                            @endcan
                        </ul>
                    </li>
                    ...
                    @if (auth()->guard('admin')->user()->hasRole('Super Admin'))
                         <li class="{{ active_menu('admin-home/area') }}
                            @if (request()->is('admin-home/seller-settings/admin-commission/all') || request()->is('admin-home/frontend/seller-verify/all')) active @endif">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-user"></i>
                    ...
                    @endcan
                      @can('seller-buyer-report')
                        <li class="{{ active_menu('admin-home/orders/seller-buyer-report') }}">
                            <a href="{{ route('admin.order.seller.buyer.report') }}"><i class="ti-list-ol"></i> {{ __('Users Report') }}</a>
                        </li>
                    @endcan
