                                    ...
                                    <div class="col-lg-8 margin-top-30">
                                        <div class="service-overview-wrapper padding-bottom-30">
                                            ...
                                            <div class="overview-single padding-top-60 extra-services">
                                                <h4 class="title">{{ get_static_option('service_additional_attribute_title') ?? __('Upgrade your booking with extras') }}
                                                </h4>
                                                <div class="row">
                        ...
                        <!-- Information -->
                            <fieldset class="padding-top-20 padding-bottom-100 confirm-information">
                                <div class="Info-overview padding-top-30">
                                    ...
                                    <div class="single-info-overview margin-top-30">
                                        <div class="single-info-input">
                                            <label class="info-title">{{ __('Booking Note*') }} </label>
                                            <textarea class="form--control textarea--form" name="order_note" id="order_note" placeholder="{{ __('Type Booking Note') }}"></textarea>
                                        ...
                                        <div class="confirm-overview-left margin-top-30">
                                            @if($service_details_for_book->is_service_online != 1)
                                                <div class="single-confirm-overview">
                                                    ...
                                                    <div class="single-confirm margin-top-30">
                                                        <h3 class="titles">{{ __('booking Location') }}</h3>
                                            ...
                                            <div class="booking-info padding-top-60">
                                                ...
                                                <div class="booking-details">
                                                    <ul class="booking-list">
                                                        ...
                                                        <li class="lists">
                                                            <span class="list-span">{{ __('Booking Note:') }}</span>
                                        ...
                                        <div class="service-overview-summery">
                                            ...
                                            <div class="overview-summery-contents">
                                                ...
                                                <div class="btn-wrapper">
                                                    @if($service_details_for_book->is_service_online == 1)
                                                        @if(Auth::guard('web')->check())
                                                            <button type="submit" class="cmn-btn btn-appoinment btn-bg-1">{{ get_static_option('service_order_confirm_title') ?? __('Pay & Confirm Your Booking') }} </button>
                                                        @else
                                                            <a class="cmn-btn btn-appoinment btn-bg-1" href="{{route('user.login')}}?return={{request()->path()}}">{{ __('Sign In') }}</a>
                                                            <small class="text-danger">{{__('Must login to create booking for online services')}}</small>
                                                        @endif
                                                    @else
                                                        <button type="submit" class="cmn-btn btn-appoinment btn-bg-1">{{ get_static_option('service_order_confirm_title') ?? __('Pay & Confirm Your Booking') }} </button>
                                                    @endif
