...
@section('page-meta-data')
    <title>{{ __('Booking Success') }}</title>
@endsection
@section('page-title')
    <?php
                ...
                <form id="msform" class="msform">
                    ...
                    <fieldset class="padding-top-80 padding-bottom-100">
                        <div class="form-card successful-card">
                            ...
                            <h5 class="purple-text text-center">{{ get_static_option('Your Booking Successfully Completed') ?? __('Your Booking Successfully Completed') }}</h5>
                            <div class="btn-wrapper margin-top-35">
                                <h4 class="mb-3">{{ get_static_option('Your Booking Details') ?? __('Your Booking Details') }}</h4>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <label><strong>{{ __('Payment Gateway:') }} </strong>
                            ...
                            <div class="btn-wrapper text-center margin-top-35">
                                ...
                                @if(auth('web')->check())
                                    ...
                                    <a href="{{ route($route_prefix.'.orders') }}" class="cmn-btn btn-bg-1">{{__('All Bookings') }}</a>
