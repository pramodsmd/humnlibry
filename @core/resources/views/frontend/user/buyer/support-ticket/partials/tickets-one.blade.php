                ...
                <div class="dashboard-right">
                    ...
                    <div class="btn-wrapper margin-top-50 text-right">
                        <a href="#" class="cmn-btn btn-bg-1" data-toggle="modal"
                           data-target="#ticketModal" > {{__('Create Ticket For A Booking' )}}</a>
                    </div>
                            ...
                            <div class="rows dash-single-inner">
                                <table class="table table-bordered">
                                    ...
                                    @foreach($tickets as $key=>$data)
                                        <tr>
                                            <td>{{ $data->id }}</td>
                                            <td>{{__('Booking Id')}} #{{ $data->order_id }}, {{ $data->title }}</td>
                                            <td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="single-dashboard-input">
                            <div class="single-info-input margin-top-30">
                                <label for="priority" class="info-title"> {{__('Select Booking')}} </label>
